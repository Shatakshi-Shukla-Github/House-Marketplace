...
//     useEffect(() => {
//         // FIXED: Added .current check
//         if (isMounted.current) {
//             onAuthStateChanged(auth, (user) => {
//                 if (user) {
//                     // FIXED: Used functional update to prevent stripping form data
...
//                 if (!apiKey) {
//                     throw new Error("API Key is missing or undefined in your environment variables.")
//                 }

//                 const response = await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${encodeURIComponent(address)}&key=${apiKey}`)
//                 const data = await response.json()

//                 console.log("Geocoding API Response Data:", data) // Temporary debug log

//                 // If Google returns anything other than OK or ZERO_RESULTS, it's an API config issue
//                 if (data.status !== "OK" && data.status !== "ZERO_RESULTS") {
//                     throw new Error(`Google API Error: ${data.status}. ${data.error_message || "Check your Google Console billing/restrictions."}`)
//                 }
...
//         // FIXED: Adjusted syntax array spread
//         const imgUrls = await Promise.all(
//             [...images].map((image) => storeImage(image))
//         ).catch(() => {
//             setLoading(false)
...
//                     <label className='formLabel'>Parking spot</label>
//                     <div className='formButtons'>
//                         <button className={parking ? 'formButtonActive' : 'formButton'} type='button' id='parking' value="true" onClick={onMutate}>
//                             Yes
//                         </button>
//                         <button className={!parking ? 'formButtonActive' : 'formButton'} type='button' id='parking' value="false" onClick={onMutate}>
//                             No
//                         </button>
//                     </div>
