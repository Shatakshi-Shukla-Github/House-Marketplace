    ...
    return (
        <main>
            <Swiper slidesPerView={1} pagination={{ clickable: true }}>
                {listing.imgUrls.map((url, index) => (
                    <SwiperSlide key={index}>
                        <div className="swiperSlideDiv" style={{ background: `url(${listing.imgUrls[index]}) center no-repeat`, backgroundSize: "cover", minHeight: "20rem" }}>
            ...
            <div className="listingDetails">
                ...
                <p className="listingType">For {listing.type === "sale" ? "Sale" : "Rent"}</p>
                {listing.offer && (
                ...
                <div className="leafletContainer">
                    <MapContainer style={{ height: "100%", width: "100" }} center={[listing.geolocation.lat, listing.geolocation.lat]} zoom={13} scrollWheelZoom={false}>
                        <TileLayer attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
                            url='https://{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png' />
                        <Marker position={[listing.geolocation.lat, listing.geolocation.lat]}>
